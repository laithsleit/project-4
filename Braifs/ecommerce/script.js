...
modeSwitch.addEventListener('click', function () {                   
 ...
 modeSwitch.classList.toggle('active');
      ...
      .then(data => {
        data.forEach(event => {
          ...
          productRow.innerHTML = `
            ...
            <div class="product-cell">
            <span class="cell-label"> section:</span>${event.section}
          </div>              
            <div class="product-cell" ">
  ...
  let searchInput = document.getElementById('lala');
    ...
    fetch(url, requestOptions)
        ...
        .then(data => {
            data.forEach(event => {
              ...
              <div class="product-cell">
                <span class="cell-label">Number of Sites:</span>${event.section}
              </div>
            
             
              <div class="product-cell" ">
              <span class="cell-label">Action:</span><button class="app-content-headerButton"><a style = "text-decoration: none;color:white" href="update-even.html?id=${event.product_id}">Edit</a></button>
              <button style ="margin-left:10px"class="app-content-headerButton"><a style = "text-decoration: none;color:white;" href="http://localhost/ecommerce/API1/prouduct/delete_product.php?id=${event.product_id}">Delete</a></button>
            </div>
