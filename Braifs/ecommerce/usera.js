...
document.documentElement.classList.toggle('light');
 modeSwitch.classList.toggle('active');
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch('http://localhost/ecommerce/API1/user/userread.php')
      ...
      .then(data => {
        data.forEach(event => {
          ...
          <div class="product-cell" ">
          <span class="cell-label">Action:</span><button class="app-content-headerButton"><a style = "text-decoration: none;color:white" href="useredit.html?id=${event.id}">Edit</a></button>
          <button   style ="margin-left:10px"class="app-content-headerButton"><a style = "text-decoration: none;color:white;" href="http://localhost/ecommerce/API1/user/userdelete.php?id=${event.id}">Delete</a></button>
        </div>
